/**
 * GymkhanaAssistantWelcome - Gymkhana Assistant welcome/new chat page
 */
...
const GymkhanaAssistantWelcome = () => {
  ...
  const handleSendMessage = async (message) => {
    ...
    try {
      const config = ASSISTANT_CONFIG.gymkhana;
        ...
        <div className="welcome-loading__content">
          ...
          <div className="welcome-loading__message">
            <div className="welcome-loading__bubble welcome-loading__bubble--assistant">
              ...
              <span className="typing-text">Gymkhana Assistant is thinking...</span>
            </div>
          </div>
        </div>
      </div>
...
export default GymkhanaAssistantWelcome;
