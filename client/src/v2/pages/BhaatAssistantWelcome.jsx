/**
 * BhaatAssistantWelcome - Bhaat Assistant welcome/new chat page
 */
...
const BhaatAssistantWelcome = () => {
  ...
  const handleSendMessage = async (message) => {
    ...
    try {
      const config = ASSISTANT_CONFIG.bhaat;
        ...
        <div className="welcome-loading__content">
          ...
          <div className="welcome-loading__message">
            <div className="welcome-loading__bubble welcome-loading__bubble--assistant">
              ...
              <span className="typing-text">Bhaat Assistant is thinking...</span>
            </div>
          </div>
        </div>
      </div>
...
export default BhaatAssistantWelcome;
